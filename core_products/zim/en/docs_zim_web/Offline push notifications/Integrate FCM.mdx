...
Navigate to [SDK downloads](./../Client%20SDKs/SDK%20downloads.mdx) to get the latest version of the ZPNs SDK, and copy the firebase-messaging-sw.js file from the SDK to the root directory of your project.
</Step>
</Steps>
