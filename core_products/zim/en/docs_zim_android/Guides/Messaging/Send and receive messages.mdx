...
zim.sendMessage(zimMultipleMessage, userID, type, config, new ZIMMessageSentFullCallback() {
    ...
    public void onMultipleMediaUploadingProgress(
        ...
        long currentFileSize,      // Total size of uploaded files in bytes (B). For example, if 20,971,520 B has been uploaded, this value will be 20,971,520.
        long totalFileSize,        // Total file size in bytes (B). For example, if the total file size is 104,857,600 B, this value will be 104,857,600.
        ...
        // This callback is triggered at a frequency of once per second.
...
notification.onMultipleMediaUploadingProgress = ^(
    ...
    unsigned long long currentFileSize,      // Total size of uploaded files in bytes (B). For example, if 20,971,520 B has been uploaded, this value will be 20,971,520.
    unsigned long long totalFileSize,        // Total file size in bytes (B). For example, if the total file size is 104,857,600 B, this value will be 104,857,600.
...
var notification = {
    ...
    onMultipleMediaUploadingProgress: function(
        message,
        currentFileSize,      // Total size of uploaded files in bytes (B). For example, if 20,971,520 B has been uploaded, this value will be 20,971,520.
        totalFileSize,        // Total file size in bytes (B). For example, if the total file size is 104,857,600 B, this value will be 104,857,600.
