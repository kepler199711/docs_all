...
| 6000213 | Unsupported image/audio/video format. Please check the format first. For more details, refer to the [Message types\|_blank](./../Guides/Messaging/Send%20and%20receive%20messages.mdx#message-types). |
| 6000214 | File size error. Please check the size first. For more about the size limit, refer to the [Message types\|_blank](./../Guides/Messaging/Send%20and%20receive%20messages.mdx#message-types).|
| 6000215 | Audio duration error. Please check the duration first. For more about the duration limit, refer to the [Message types\|_blank](./../Guides/Messaging/Send%20and%20receive%20messages.mdx#message-types). |
