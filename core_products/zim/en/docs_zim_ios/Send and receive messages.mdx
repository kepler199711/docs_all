...
- The “userID” and “userName” support custom rules defined by developers. It is recommended that you set the “userID” to a meaningful value to associate it with your own account system.
