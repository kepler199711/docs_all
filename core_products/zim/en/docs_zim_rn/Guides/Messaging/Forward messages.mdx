...
2. To send a combined message, call the [sendMessage](@sendMessage) operation. For more information about this operation, see [Send & Receive messages - Send messages](./Send%20and%20receive%20messages.mdx#send-messages).
...
Call the same operation for receiving ordinary messages to receive a combined message. For more information about this operation, see [Send & Receive messages - Receive messages](./Send%20and%20receive%20messages.mdx#receive-messages).
