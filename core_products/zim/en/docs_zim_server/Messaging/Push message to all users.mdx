...
</li><li>If the message fails to be sent to all users, the Code will return the corresponding return code. Please refer to [Return codes](./../Return%20codes.mdx). </li></ul></div></td>
</tr>
<tr data-row-level="3">
<td>Message</td>
<td>String</td>
