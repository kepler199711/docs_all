...
<Note title="Note">Messages sent through this interface will not create a conversation or be saved.</Note>
...
</li><li>If the message fails to be sent to all users, the Code will return the corresponding return code. Please refer to <a href="../Return codes.mdx">Return Codes</a>. </li></ul></Note></td>
</tr>
<tr data-row-level="3">
<td>Message</td>
<td>String</td>
