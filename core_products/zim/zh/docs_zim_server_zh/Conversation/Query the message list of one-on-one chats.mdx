...
<td>Next</td>
<td>Number</td>
<td>分页拉取标志。<ul><li>非 0：表示还有消息未返回，需要将该字段设置到请求参数 Next&nbsp;中拉取更多消息。</li><li>为 0：表示已经返回完整消息列表。</li></ul></td>
</tr>
