...
请参考 [Web 推送集成指南](./Integrate%20FCM.mdx)，集成 FCM 离线推送 SDK。
...
1. 首先开发者需要通过 [ZIMPushConfig](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMPushConfig-class.html) 对象，设置离线推送标题、内容、以及其它自定义属性。
...
1. 开发者通过 [ZIMPushConfig](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMPushConfig-class.html) 对象，设置离线推送标题、内容、以及其它自定义属性。
