...
- 开发环境与测试设备满足以下要求：
    ...
    <Tab title="适用于 HarmonyOS 开发">
    - 开发环境：已参考 [OpenHarmony-SIG/flutter_flutter](https://gitee.com/openharmony-sig/flutter_flutter) 安装了适配 HarmonyOS Next 的 Flutter。
    - 测试设备：
        - 支持 HarmonyOS 5.0.0 Release 操作系统或以上版本的 HarmonyOS 设备真机或模拟器。
        - 设备已经连接到 Internet。 
    </Tab>
    </Tabs>
