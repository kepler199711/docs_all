...
4. 选择对应的运行设备，单击 “Android Studio” 右上角的 “Run” 按钮，运行示例 App，即可体验 ZIM。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZIM/flutter/run_example_demo_0.png" /></Frame>
...
4. 选择 “Run > Run without Debugging”，运行示例 App，即可体验 ZIM。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZIM/flutter/run_example_demo_1.png" /></Frame>
