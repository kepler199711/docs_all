...
[升级到 2.13.0 版本的编译问题，升级前必看 >>](#16129#2_13_0)
</div>
...
| 群消息管理 | 支持新进入群组成员自动获取群历史消息。<div class="mk-hint"><p>如需使用此功能，请联系 ZEGO 技术支持配置。</p></div> | <ul><li>[joinGroup](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/joinGroup.html)</li><li>[inviteUsersIntoGroup](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/inviteUsersIntoGroup.html)</li></ul> |
...
[升级到 2.9.0 版本的编译问题，升级前必看 >>](#16129#2_9_0)
</div>
...
| 查询房间内用户状态 | 通过指定若干 userID 和 roomID，查询目标用户是否在指定房间内，从而进行业务逻辑设计，如邀请连麦。<div class="mk-hint"><p>最多支持一次性查询 10 名用户的信息。</p></div> | [queryRoomMember](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/queryRoomMembers.html) |
...
| 功能项  | 功能描述 | 相关接口 |
|-------|-------|-------|
|消息撤回|  撤回发送成功的消息，默认撤回 2 分钟内的消息。撤回操作仅支持撤回单聊和群聊的消息，不支持撤回房间内消息。<div class="mk-hint"><p>如需配置撤回时间，请联系 ZEGO 技术支持。</p></div>| <ul><li>[revokeMessage](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIM/revokeMessage.html)</li><li>[ZIMMessageRevokedResult](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMMessageRevokedResult-class.html)</li></ul>|
...
[升级到 2.3.0 版本的编译问题，升级前必看 >>](#16129#2.3.0)
</div>
