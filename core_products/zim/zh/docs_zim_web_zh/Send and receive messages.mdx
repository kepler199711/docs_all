...
请参考 [3.1 导入 SDK](#32-导入-sdk)，选择 “方式一：使用 npm 获取 SDK”，导入 SDK 文件。
...
临时 Token 仅供调试，正式上线前，请从开发者的业务服务器生成 Token，详情可参考 [使用 Token 鉴权](!IM-common_features/Authenticate_users_with_tokens)。
</Warning>
