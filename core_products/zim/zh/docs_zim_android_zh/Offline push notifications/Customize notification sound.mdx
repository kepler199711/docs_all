...
- 已集成 ZPNs SDK，详情请参考 [实现离线推送\|_blank](./Implement%20offline%20push%20notification.mdx)。
- 已在控制台配置离线推送证书。
...
详情请参考 Apple 开发者文档 [UNNotificationSound\|_blank](https://developer.apple.com/documentation/usernotifications/unnotificationsound?language=objc)。
...
<Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZIM/OfflinePush/Pop_out_1.jpeg" /></Frame>
