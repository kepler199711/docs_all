...
1. 参考安卓厂商推送集成指南（[小米](./Integrate%20Xiaomi.mdx)/[华为](./Integrate%20Huawei.mdx)/[OPPO](./Integrate%20OPPO.mdx)/[vivo](./Integrate%20vivo.mdx)/[Google FCM](./Integrate%20FCM.mdx)），为 2 个工程分别获取适用于各厂商的 2 份离线推送证书。
