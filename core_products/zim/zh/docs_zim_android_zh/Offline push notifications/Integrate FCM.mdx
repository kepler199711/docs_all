...
Google 推送 [FCM\|_blank](https://firebase.google.com)（Firebase Cloud Messaging）是一种跨平台消息传递解决方案，支持海外用户推送离线消息，可供开发者可靠地传递消息。
...
- 已完成如下步骤：
    ...
    1. 前往 [Firebase 平台\|_blank](https://console.firebase.google.com/)，登录自己的 [Google 账号\|_blank](https://support.google.com/accounts/answer/27441?hl=zh-Hans&ref_topic=3382296)。
