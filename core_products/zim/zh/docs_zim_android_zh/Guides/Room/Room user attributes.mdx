...
设置成功后，可以通过 [ZIMRoomMembersAttributesOperatedResult\|_blank](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMRoomMembersAttributesOperatedResult-class.html) 的异步返回值，获取操作结果。
:::
...
:::if{props.platform="Flutter"}
查询成功后，可以通过 [ZIMRoomMembersAttributesQueriedResult\|_blank](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMRoomMembersAttributesQueriedResult-class.html) 的异步返回值，获取查询结果。
:::
...
:::if{props.platform="Flutter"}
查询成功后，会返回该房间内所有用户的用户属性。可以通过 [ZIMRoomMemberAttributesListQueriedResult\|_blank](https://pub.dev/documentation/zego_zim/latest/zego_zim/ZIMRoomMemberAttributesListQueriedResult-class.html) 的异步返回值，获取查询结果。
:::
