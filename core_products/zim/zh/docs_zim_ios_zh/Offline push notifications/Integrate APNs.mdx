...
<Frame width="512" height="auto" caption="">
  <img src="https://storage.zego.im/sdk-doc/Pics/ZIM/open_keychain_access.png" />
</Frame>

7. 选择 “钥匙串访问 > 证书助理 > 从证书颁发机构请求证书”，填写 “用户电子邮件地址” 和 “常用名称”，勾选“存储到磁盘”，点击“继续”，将得到后缀名为 “.certSigningRequest” 的文件（即 CSR 文件）。

<Frame width="512" height="auto" caption="">
  <img src="https://storage.zego.im/sdk-doc/Pics/ZIM/request_certificate.png" />
</Frame>
<Frame width="512" height="auto" caption="">
  <img src="https://storage.zego.im/sdk-doc/Pics/ZIM/apns_apply_1.png" />
</Frame>
...
<Frame width="512" height="auto" caption="">
  <img src="https://storage.zego.im/sdk-doc/Pics/ZIM/export_certificate.png" />
</Frame>
