...
- 开发环境：
    ...
    - 获取配套 API Version 12 Release 的 HarmonyOS 5.0.0 Release 操作系统或以上版本的鸿蒙设备，且已开启“允许调试”选项。
...
<Accordion title="此步骤以如何创建新项目为例，如果是集成到已有项目，可忽略此步。" defaultOpen="false">
    ...
    <img src="https://media-resource.spreading.io/docuo/workspace745/03e04f98099440df3547898e90a80a96/c9c9584bf2.jpeg" alt="20250109-105149.jpeg"/>
    </Frame>
    </Step>
    <Step title="选择项目模板">
    ...
    <Frame width="auto" height="auto" caption="">
    <img src="https://media-resource.spreading.io/docuo/workspace745/03e04f98099440df3547898e90a80a96/4cebd36b22.jpeg" alt="20250109-105155.jpeg"/>
    </Frame>
    </Step>
    <Step title="填写信息">
    ...
    填写您项目名称、设备类型等信息。
    <Frame width="auto" height="auto" caption="">
    <img src="https://media-resource.spreading.io/docuo/workspace745/03e04f98099440df3547898e90a80a96/03f53ea813.jpeg" alt="20250109-105159.jpeg"/>
    </Frame>
