...
<Card title="示例源码" href="https://storage.zego.im/zim/example/windows/ZIMDemo.zip" target="_blank">点击获得完整代码。</Card>
## 1 概览
...
<Frame width="512" height="auto" caption="">
  <img src="https://storage.zego.im/sdk-doc/Pics/ZIM/sava_sdk.png" />
</Frame>
...
2. 使用 IDE 打开项目。
  ...
  1. 在开发电脑中找到 Qt 软件，并打开。
      ...
      <Frame width="512" height="auto" caption="">
      <img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Windows/qt_icon.png" />
      </Frame>

    2. 选择 Projects，点击右侧的 Open。

      <Frame width="512" height="auto" caption="">
      <img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Windows/qt_open.png" />
      </Frame>

    3. 在解压后的示例源码文件夹中，选择 “ZIMQTDemo” 下的 “ZIMQTDemo.pro” 文件，打开工程。

<Frame width="512" height="auto" caption="">
<img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Windows/qt_path_icon.png" />
</Frame>
...
3. 点击左侧 Dubug，选择 MSVC2017 组件，再点击 Debug 选项，编译并运行项目。
    ...
    **Windows 系统选用 MSVC2017 组件；macOS 系统使用默认的 Clang 即可。**
    ...
    <Frame width="512" height="auto" caption="">
      <img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Windows/qt_debug_icon.png" />
    </Frame>
...
4. 代码运行起来后，在弹出的 ZIM 对话框中，填写您的 userID（必填）、userName。
    ...
    <Frame width="512" height="auto" caption="">
      <img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Windows/login.png" />
    </Frame>
