...
---
<Card title="示例源码" href="https://storage.zego.im/zim/example/unity/Unity3dDemo.zip" target="_blank">点击获得完整代码。</Card>
## 准备环境
...
3. 点击 Unity Hub 的 “Projects” 选项卡，单击右上角 “Open”，打开下载好的示例源码。
    ...
    <Frame width="512" height="auto" caption=""><img src="https://storage.zego.im/sdk-doc/Pics/ZIM/Unity/demoDownload.jpeg" /></Frame>
