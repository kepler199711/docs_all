# Customize member avatars

This doc describes how to customize user avatars in the member list.
...
To customize user avatars in the member list, perform the following steps:
