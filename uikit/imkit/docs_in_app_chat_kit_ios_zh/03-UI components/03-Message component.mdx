...
| 消息支持的操作类型    | 文字消息 | 图片消息 |  视频消息 | 文件消息 | 语音消息 | 组合消息 |
| ------------------ | ------  | -------- | -------- | --------| ------ | ------- |
| copy               | 支持     | 不支持    | 不支持   | 不支持    | 不支持    |  不支持  |
| reply              | 支持     | 支持     | 支持     | 支持     | 支持     | 支持     |
| forward            | 支持     | 支持     | 支持     | 支持     | 不支持     | 支持     |
| multipleChoice     | 支持     | 支持     | 支持     | 支持     | 支持     | 支持     |
| delete             | 支持     | 支持     | 支持     | 支持     | 支持     | 支持     |
| revoke             | 支持     | 支持     | 支持     | 支持     | 支持     | 支持     |
| speaker            | 不支持   | 不支持    | 不支持   | 不支持   | 支持     | 不支持     |
| reaction           | 支持     | 支持     | 支持     | 支持     | 支持     | 支持     |
...
In-app Chat Kit 提供一系列默认表情用于在会话中发送表情，以及对消息进行表态。如果您不满意默认提供的表情，您可以通过 `bottomConfig.emojis` 传入所有您需要的表情。
