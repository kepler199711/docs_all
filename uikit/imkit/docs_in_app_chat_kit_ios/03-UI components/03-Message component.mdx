...
| Types of operations supported by messages | Text messages | image messages | video messages | file messages | voice messages | Combination messages |
| ------------------ | ------  | -------- | -------- | --------| ------ | ------- |
| copy | supported | unsupported | unsupported | unsupported | unsupported | is not supported |
| reply | support | support | support | support | support | support |
| forward | supported | supported | supported | supported | unsupported | supported |
| multipleChoice | support | support | support | support | support | support |
| delete | support | support | support | support | support | support |
| revoke | supports | supports | supports | supports | supports |
| speaker | not supported | not supported | not supported | not supported | supported | not supported |
| reaction | support | support | support | support | support | support |
