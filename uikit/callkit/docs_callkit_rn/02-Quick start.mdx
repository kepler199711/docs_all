...
- Please take a notice that our SDK not support Expo now. Some features of the SDK require to modify the native code layer which expo not support. It is recommended to integrate call kit with a standard react native project.
