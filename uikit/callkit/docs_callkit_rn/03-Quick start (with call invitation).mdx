...
<CodeGroup>
```bash yarn
yarn add @zegocloud/zego-uikit-rn react-delegate-component @react-navigation/native @react-navigation/native-stack react-native-screens react-native-safe-area-context react-native-sound react-native-encrypted-storage zego-express-engine-reactnative zego-zim-react-native@2.19.0 zego-zpns-react-native zego-callkit-react-native react-native-keep-awake@4.0.0 react-native-device-info
```
